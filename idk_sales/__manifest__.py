{
    ...
    Added a new field called 'Total Cost' which is the a sum of the fields 'Material Cost' + 'Overhead Cost' + 'Labor Cost' + 'Parts Material Cost' + 'Freight In' + 'Freight Out'
